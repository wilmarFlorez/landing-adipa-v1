...
function SuccessMessage() {
  return (
    <div
      role="status"
      aria-live="polite"
      className="flex flex-col items-center gap-4 rounded-card bg-white p-10 text-center shadow-card dark:bg-darkCard"
    >
      ...
      <p className="font-body text-dark/60 dark:text-darkText/60">
        Gracias por contactarnos. Te responderemos a la brevedad en el email que nos proporcionaste.
      </p>
    </div>
  )
}
...
function ContactSidebar() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <p className="font-body text-lg leading-relaxed text-dark/70 dark:text-darkText/70">
        ¿Tienes dudas sobre nuestros cursos o programas? Escríbenos y un asesor académico te
      ...
      <ul className="flex flex-col gap-5">
        ...
        <li className="flex items-start gap-4">
          ...
          <div>
            <p className="font-heading text-sm font-semibold text-dark dark:text-darkText">
              Teléfono
            </p>
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          {submitted ? (
            ...
            <form
              ...
              noValidate
              className="flex flex-col gap-5 rounded-card bg-white p-8 shadow-card dark:bg-darkCard"
            >
              <FormField
                id="name"
              ...
              >
                <textarea
                  ...
                  onBlur={handleBlur}
                  aria-describedby={
                    getFieldState("message") === "error" ? "message-error" : undefined
                  }
